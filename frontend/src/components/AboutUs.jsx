...
import noni from "./img/adnan.jpg";
  ...
  return (
    <>
      <div class="wrapper">
        <div class="banner flex inner">
          <div class="right">
            ...
            <p>
              At Desi Traditional Food, we understand the joy of sharing your culinary
      ...
      <div class="alert alert-success" role="success" style={{width:"70%",marginLeft:"15%"}}>
        <h4 class="alert-success">Welcome to About Us of  Desi Traditional Food</h4>
        <p>
        Desi Traditional Food is more than just a food platform. We are passionate about
        ...
        <hr></hr>
        <p class="mb-0">
          At Desi Traditional Food, we believe that food is a universal language that transcends
          borders and cultures. Whether you're a seasoned chef or an amateur
          cook,  Desi Traditional Food welcomes you to explore, experiment, and share your unique

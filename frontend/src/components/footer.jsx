      ...
      <div className="container">
        <div className="row">
          <div className="col-md-4">
            <h5>About Us</h5>
            <p>
            Desi Traditional Food is a proposed website that aims to provide a
          ...
          <div className="col-md-4">
            ...
            <address>
              <p>Adnan Haider</p>
              <p>COMSATS, Pakaistan</p>
              <p>Email: adnanhiader9993@gamil.com</p>
            </address>
          </div>
        </div>
        <hr className="my-4" />
        <div className="row">
          <div className="col-md-6">
            <p>&copy; {new Date().getFullYear()}  Desi Traditional Food(The Recipie)</p>
          </div>
          <div className="col-md-6">
